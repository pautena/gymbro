...
export class WorkoutsService {
     ...
     * Retrieve workouts.
     */
    public static readWorkouts<ThrowOnError extends boolean = true>(options?: Options<WorkoutsReadWorkoutsData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<WorkoutsReadWorkoutsResponse, WorkoutsReadWorkoutsError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     * Create new workout.
     */
    public static createWorkout<ThrowOnError extends boolean = true>(options: Options<WorkoutsCreateWorkoutData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<WorkoutsCreateWorkoutResponse, WorkoutsCreateWorkoutError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     * Delete an workout.
     */
    public static deleteWorkout<ThrowOnError extends boolean = true>(options: Options<WorkoutsDeleteWorkoutData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<WorkoutsDeleteWorkoutResponse, WorkoutsDeleteWorkoutError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     * Get workout by ID.
     */
    public static readWorkout<ThrowOnError extends boolean = true>(options: Options<WorkoutsReadWorkoutData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<WorkoutsReadWorkoutResponse, WorkoutsReadWorkoutError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     * Update an workout.
     */
    public static updateWorkout<ThrowOnError extends boolean = true>(options: Options<WorkoutsUpdateWorkoutData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).put<WorkoutsUpdateWorkoutResponse, WorkoutsUpdateWorkoutError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
